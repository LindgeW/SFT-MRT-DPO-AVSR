...
class TransformerEncoder(nn.Module):
    ...
    """
    def __init__(self, embed_dim, num_heads, num_layers, attn_dropout=0.1, relu_dropout=0.1, res_dropout=0.1, embed_dropout=0.2, need_pos_enc=True, attn_mask=False):
        super().__init__()
